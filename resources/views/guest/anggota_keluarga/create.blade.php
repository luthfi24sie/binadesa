...
<head>
    ...
    <title>Tambah Anggota Keluarga - Sistem Kependudukan</title>
                    ...
                    <div class="p-4">
                        ...
                        <div class="card">
                            <div class="card-header bg-white">
                                <h5 class="mb-0"><i class="fas fa-plus me-2"></i>Form Tambah Anggota Keluarga</h5>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('anggota-keluarga.store') }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select @error('hubungan') is-invalid @enderror" 
                                            ...
                                            <option value="Pembantu" {{ old('hubungan') == 'Pembantu' ? 'selected' : '' }}>Pembantu</option>
