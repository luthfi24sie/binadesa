...
<head>
    ...
    <title>Tambah Data Warga - Sistem Kependudukan</title>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('pendidikan_terakhir') is-invalid @enderror" 
                                                ...
                                                <option value="Tidak Tamat SD/Sederajat" {{ old('pendidikan_terakhir') == 'Tidak Tamat SD/Sederajat' ? 'selected' : '' }}>Tidak Tamat SD/Sederajat</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('status_kependudukan') is-invalid @enderror" 
                                                ...
                                                <option value="Warga Sementara" {{ old('status_kependudukan') == 'Warga Sementara' ? 'selected' : '' }}>Warga Sementara</option>
                                                <option value="Pendatang" {{ old('status_kependudukan') == 'Pendatang' ? 'selected' : '' }}>Pendatang</option>
                                                <option value="Pindah Keluar" {{ old('status_kependudukan') == 'Pindah Keluar' ? 'selected' : '' }}>Pindah Keluar</option>
                                            </select>
